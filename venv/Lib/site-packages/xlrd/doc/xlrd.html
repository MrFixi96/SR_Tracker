...
<dl>
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#biffh.BaseObject-class'><i>The BaseObject Class</i></a>.
        </p>
    </dd>
    ...
    <dt><a id='formula.cellname-function' name='formula.cellname-function'><b>cellname(rowx, colx)</b></a> [<a
            href='#formula.cellname-function'>#</a>]
    </dt>
    <dd>
        <p>Utility function: (5, 7) =&gt; 'H6'</p>
    </dd>
    <dt><a id='formula.cellnameabs-function' name='formula.cellnameabs-function'><b>cellnameabs(rowx, colx, r1c1=0)</b></a>
        [<a href='#formula.cellnameabs-function'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formula.colname-function' name='formula.colname-function'><b>colname(colx)</b></a> [<a
            href='#formula.colname-function'>#</a>]
    </dt>
    <dd>
        <p>Utility function: 7 =&gt; 'H', 27 =&gt; 'AB'</p>
    </dd>
    <dt><a id='__init__.count_records-function' name='__init__.count_records-function'><b>count_records(filename,
        outfile=sys.stdout)</b></a> [<a href='#__init__.count_records-function'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.dump-function' name='__init__.dump-function'><b>dump(filename, outfile=sys.stdout,
        unnumbered=False)</b></a> [<a href='#__init__.dump-function'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.empty_cell-variable' name='sheet.empty_cell-variable'><b>empty_cell</b></a> (variable) [<a
            href='#sheet.empty_cell-variable'>#</a>]
    </dt>
    <dd>
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.EqNeAttrs-class'><i>The EqNeAttrs
            Class</i></a>.</p>
    </dd>
    <dt><a id='biffh.error_text_from_code-variable'
           name='biffh.error_text_from_code-variable'><b>error_text_from_code</b></a> (variable) [<a
            href='#biffh.error_text_from_code-variable'>#</a>]
    </dt>
    <dd>
        <p/>
...
0x2A: '#N/A',    # Argument or function not available
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.Format-class'><i>The Format Class</i></a>.
        </p>
    </dd>
    <dt><b>Hyperlink</b> (class) [<a href='#sheet.Hyperlink-class'>#</a>]</dt>
    <dd>
        <p>Contains the attributes of a hyperlink.</p>
        <p>For more information about this class, see <a href='#sheet.Hyperlink-class'><i>The Hyperlink Class</i></a>.
        </p>
    </dd>
    ...
    <dt><a id='__init__.open_workbook-function' name='__init__.open_workbook-function'><b>open_workbook(filename=None,
        ...
        )</b></a> [<a href='#__init__.open_workbook-function'>#</a>]
    </dt>
    <dd>
    ...
    <dt><b>Operand(akind=None, avalue=None, arank=0, atext='?')</b> (class) [<a href='#formula.Operand-class'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formula.rangename3d-function' name='formula.rangename3d-function'><b>rangename3d(book, ref3d)</b></a> [<a
            href='#formula.rangename3d-function'>#</a>]
    </dt>
    <dd>
        <p>Utility function:
            <br/> Ref3D((1, 4, 5, 20, 7, 10)) =&gt; 'Sheet2:Sheet3!$H$6:$J$20'
        </p></dd>
    <dt><a id='formula.rangename3drel-function' name='formula.rangename3drel-function'><b>rangename3drel(book, ref3d,
        browx=None, bcolx=None, r1c1=0)</b></a> [<a href='#formula.rangename3drel-function'>#</a>]
    </dt>
    <dd>
        <p>Utility function:
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.XFAlignment-class'><i>The XFAlignment
            Class</i></a>.</p>
    </dd>
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.XFBackground-class'><i>The XFBackground
            Class</i></a>.</p>
    </dd>
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.XFBorder-class'><i>The XFBorder Class</i></a>.
        </p>
    </dd>
    ...
    <dd>
        ...
        <p>For more information about this class, see <a href='#formatting.XFProtection-class'><i>The XFProtection
            Class</i></a>.</p>
    </dd>
    <dt><a id='xldate.xldate_as_tuple-function' name='xldate.xldate_as_tuple-function'><b>xldate_as_tuple(xldate,
        datemode)</b></a> [<a href='#xldate.xldate_as_tuple-function'>#</a>]
    </dt>
    <dd>
        ...
        <dl>
            ...
            <dt>Raises <b>XLDateNegative</b>:</dt>
            <dd>
                xldate &lt; 0.00
            </dd>
            <dt>Raises <b>XLDateAmbiguous</b>:</dt>
            <dd>
                The 1900 leap-year problem (datemode == 0 and 1.0 &lt;= xldate &lt; 61.0)
            </dd>
            <dt>Raises <b>XLDateTooLarge</b>:</dt>
            <dd>
                Gregorian year 10000 or later
            </dd>
            <dt>Raises <b>XLDateBadDatemode</b>:</dt>
            <dd>
                datemode arg is neither 0 nor 1
            </dd>
            <dt>Raises <b>XLDateError</b>:</dt>
            <dd>
    ...
    <dt><a id='xldate.xldate_from_date_tuple-function' name='xldate.xldate_from_date_tuple-function'><b>xldate_from_date_tuple((year,
        month, day), datemode)</b></a> [<a href='#xldate.xldate_from_date_tuple-function'>#</a>]
    </dt>
    <dd>
        ...
        <dl>
            ...
            <dt>Raises <b>XLDateBadTuple</b>:</dt>
            <dd>
    ...
    <dt><a id='xldate.xldate_from_datetime_tuple-function' name='xldate.xldate_from_datetime_tuple-function'><b>xldate_from_datetime_tuple(datetime_tuple,
        datemode)</b></a> [<a href='#xldate.xldate_from_datetime_tuple-function'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='xldate.xldate_from_time_tuple-function' name='xldate.xldate_from_time_tuple-function'><b>xldate_from_time_tuple((hour,
        minute, second))</b></a> [<a href='#xldate.xldate_from_time_tuple-function'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='biffh.BaseObject.dump-method' name='biffh.BaseObject.dump-method'><b>dump(f=None, header=None,
        footer=None, indent=0)</b></a> [<a href='#biffh.BaseObject.dump-method'>#</a>]
    </dt>
    <dd>
        <dl>
            <dt><i>f</i></dt>
...
<dl>
    ...
    <dt><a id='__init__.Book.biff_version-attribute' name='__init__.Book.biff_version-attribute'><b>biff_version</b></a>
        [<a href='#__init__.Book.biff_version-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.codepage-attribute' name='__init__.Book.codepage-attribute'><b>codepage</b></a> [<a
            href='#__init__.Book.codepage-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.colour_map-attribute' name='__init__.Book.colour_map-attribute'><b>colour_map</b></a> [<a
            href='#__init__.Book.colour_map-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.countries-attribute' name='__init__.Book.countries-attribute'><b>countries</b></a> [<a
            href='#__init__.Book.countries-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.datemode-attribute' name='__init__.Book.datemode-attribute'><b>datemode</b></a> [<a
            href='#__init__.Book.datemode-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.encoding-attribute' name='__init__.Book.encoding-attribute'><b>encoding</b></a> [<a
            href='#__init__.Book.encoding-attribute'>#</a>]
    </dt>
    <dd>
        <p>The encoding that was derived from the codepage.</p>
    </dd>
    <dt><a id='__init__.Book.font_list-attribute' name='__init__.Book.font_list-attribute'><b>font_list</b></a> [<a
            href='#__init__.Book.font_list-attribute'>#</a>]
    </dt>
    <dd>
        <p>A list of Font class instances, each corresponding to a FONT record.
            <br/> -- New in version 0.6.1
        </p></dd>
    <dt><a id='__init__.Book.format_list-attribute' name='__init__.Book.format_list-attribute'><b>format_list</b></a>
        [<a href='#__init__.Book.format_list-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.format_map-attribute' name='__init__.Book.format_map-attribute'><b>format_map</b></a> [<a
            href='#__init__.Book.format_map-attribute'>#</a>]
    </dt>
    <dd>
        <p>The mapping from XF.format_key to Format object.
            <br/> -- New in version 0.6.1
        </p></dd>
    <dt><a id='__init__.Book.load_time_stage_1-attribute' name='__init__.Book.load_time_stage_1-attribute'><b>load_time_stage_1</b></a>
        [<a href='#__init__.Book.load_time_stage_1-attribute'>#</a>]
    </dt>
    <dd>
        <p>Time in seconds to extract the XLS image as a contiguous string (or mmap equivalent).</p>
    </dd>
    <dt><a id='__init__.Book.load_time_stage_2-attribute' name='__init__.Book.load_time_stage_2-attribute'><b>load_time_stage_2</b></a>
        [<a href='#__init__.Book.load_time_stage_2-attribute'>#</a>]
    </dt>
    <dd>
        <p>Time in seconds to parse the data from the contiguous string (or mmap equivalent).</p>
    </dd>
    <dt><a id='__init__.Book.name_and_scope_map-attribute' name='__init__.Book.name_and_scope_map-attribute'><b>name_and_scope_map</b></a>
        [<a href='#__init__.Book.name_and_scope_map-attribute'>#</a>]
    </dt>
    <dd>
        <p>A mapping from (lower_case_name, scope) to a single Name object.
            <br/> -- New in version 0.6.0
        </p></dd>
    <dt><a id='__init__.Book.name_map-attribute' name='__init__.Book.name_map-attribute'><b>name_map</b></a> [<a
            href='#__init__.Book.name_map-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.name_obj_list-attribute' name='__init__.Book.name_obj_list-attribute'><b>name_obj_list</b></a>
        [<a href='#__init__.Book.name_obj_list-attribute'>#</a>]
    </dt>
    <dd>
        <p>List containing a Name object for each NAME record in the workbook.
            <br/> -- New in version 0.6.0
        </p></dd>
    <dt><a id='__init__.Book.nsheets-attribute' name='__init__.Book.nsheets-attribute'><b>nsheets</b></a> [<a
            href='#__init__.Book.nsheets-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.palette_record-attribute'
           name='__init__.Book.palette_record-attribute'><b>palette_record</b></a> [<a
            href='#__init__.Book.palette_record-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.release_resources-method' name='__init__.Book.release_resources-method'><b>release_resources()</b></a>
        [<a href='#__init__.Book.release_resources-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.sheet_by_index-method'
           name='__init__.Book.sheet_by_index-method'><b>sheet_by_index(sheetx)</b></a> [<a
            href='#__init__.Book.sheet_by_index-method'>#</a>]
    </dt>
    <dd>
        <dl>
            <dt><i>sheetx</i></dt>
    ...
    <dt><a id='__init__.Book.sheet_by_name-method' name='__init__.Book.sheet_by_name-method'><b>sheet_by_name(sheet_name)</b></a>
        [<a href='#__init__.Book.sheet_by_name-method'>#</a>]
    </dt>
    <dd>
        <dl>
    ...
    <dt><a id='__init__.Book.sheet_loaded-method' name='__init__.Book.sheet_loaded-method'><b>sheet_loaded(sheet_name_or_index)</b></a>
        [<a href='#__init__.Book.sheet_loaded-method'>#</a>]
    </dt>
    <dd>
        <dl>
    ...
    <dt><a id='__init__.Book.sheet_names-method' name='__init__.Book.sheet_names-method'><b>sheet_names()</b></a> [<a
            href='#__init__.Book.sheet_names-method'>#</a>]
    </dt>
    <dd>
        <dl>
            <dt>Returns:</dt>
    ...
    <dt><a id='__init__.Book.sheets-method' name='__init__.Book.sheets-method'><b>sheets()</b></a> [<a
            href='#__init__.Book.sheets-method'>#</a>]
    </dt>
    <dd>
        <dl>
            <dt>Returns:</dt>
    ...
    <dt><a id='__init__.Book.style_name_map-attribute'
           name='__init__.Book.style_name_map-attribute'><b>style_name_map</b></a> [<a
            href='#__init__.Book.style_name_map-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Book.unload_sheet-method' name='__init__.Book.unload_sheet-method'><b>unload_sheet(sheet_name_or_index)</b></a>
        [<a href='#__init__.Book.unload_sheet-method'>#</a>]
    </dt>
    <dd>
        <dl>
            <dt><i>sheet_name_or_index</i></dt>
    ...
    <dt><a id='__init__.Book.user_name-attribute' name='__init__.Book.user_name-attribute'><b>user_name</b></a> [<a
            href='#__init__.Book.user_name-attribute'>#</a>]
    </dt>
    <dd>
        <p>What (if anything) is recorded as the name of the last user to save the file.</p>
    </dd>
    <dt><a id='__init__.Book.xf_list-attribute' name='__init__.Book.xf_list-attribute'><b>xf_list</b></a> [<a
            href='#__init__.Book.xf_list-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dd>
        ...
        <p>WARNING: You don't call this class yourself. You access Cell objects
            via methods of the <a class="link" href="#sheet.Sheet-class"><b>Sheet</b></a> object(s) that you found in
            the <a class="link" href="link:#Book"><b>Book</b></a> object that
            was returned when you called xlrd.open_workbook("myfile.xls").</p>
...
<dl>
    ...
    <dt><a id='sheet.Colinfo.bit1_flag-attribute' name='sheet.Colinfo.bit1_flag-attribute'><b>bit1_flag</b></a> [<a
            href='#sheet.Colinfo.bit1_flag-attribute'>#</a>]
    </dt>
    <dd>
        <p>Value of a 1-bit flag whose purpose is unknown
            but is often seen set to 1</p>
    </dd>
    <dt><a id='sheet.Colinfo.collapsed-attribute' name='sheet.Colinfo.collapsed-attribute'><b>collapsed</b></a> [<a
            href='#sheet.Colinfo.collapsed-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = column is collapsed</p>
    </dd>
    <dt><a id='sheet.Colinfo.hidden-attribute' name='sheet.Colinfo.hidden-attribute'><b>hidden</b></a> [<a
            href='#sheet.Colinfo.hidden-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = column is hidden</p>
    </dd>
    <dt><a id='sheet.Colinfo.outline_level-attribute' name='sheet.Colinfo.outline_level-attribute'><b>outline_level</b></a>
        [<a href='#sheet.Colinfo.outline_level-attribute'>#</a>]
    </dt>
    <dd>
        <p>Outline level of the column, in range(7).
            (0 = no outline)</p>
    </dd>
    <dt><a id='sheet.Colinfo.width-attribute' name='sheet.Colinfo.width-attribute'><b>width</b></a> [<a
            href='#sheet.Colinfo.width-attribute'>#</a>]
    </dt>
    <dd>
        <p>Width of the column in 1/256 of the width of the zero character,
            using default font (first FONT record in the file).</p>
    </dd>
    <dt><a id='sheet.Colinfo.xf_index-attribute' name='sheet.Colinfo.xf_index-attribute'><b>xf_index</b></a> [<a
            href='#sheet.Colinfo.xf_index-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.Font.bold-attribute' name='formatting.Font.bold-attribute'><b>bold</b></a> [<a
            href='#formatting.Font.bold-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Characters are bold. Redundant; see &quot;weight&quot; attribute.</p>
    </dd>
    <dt><a id='formatting.Font.character_set-attribute'
           name='formatting.Font.character_set-attribute'><b>character_set</b></a> [<a
            href='#formatting.Font.character_set-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.Font.colour_index-attribute' name='formatting.Font.colour_index-attribute'><b>colour_index</b></a>
        [<a href='#formatting.Font.colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>An explanation of &quot;colour index&quot; is given in the Formatting
            section at the start of this document.</p>
    </dd>
    <dt><a id='formatting.Font.escapement-attribute' name='formatting.Font.escapement-attribute'><b>escapement</b></a> [<a
            href='#formatting.Font.escapement-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Superscript, 2 = Subscript.</p>
    </dd>
    <dt><a id='formatting.Font.family-attribute' name='formatting.Font.family-attribute'><b>family</b></a> [<a
            href='#formatting.Font.family-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.Font.font_index-attribute' name='formatting.Font.font_index-attribute'><b>font_index</b></a> [<a
            href='#formatting.Font.font_index-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.Font.height-attribute' name='formatting.Font.height-attribute'><b>height</b></a> [<a
            href='#formatting.Font.height-attribute'>#</a>]
    </dt>
    <dd>
        <p>Height of the font (in twips). A twip = 1/20 of a point.</p>
    </dd>
    <dt><a id='formatting.Font.italic-attribute' name='formatting.Font.italic-attribute'><b>italic</b></a> [<a
            href='#formatting.Font.italic-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Characters are italic.</p>
    </dd>
    <dt><a id='formatting.Font.name-attribute' name='formatting.Font.name-attribute'><b>name</b></a> [<a
            href='#formatting.Font.name-attribute'>#</a>]
    </dt>
    <dd>
        <p>The name of the font. Example: u&quot;Arial&quot;</p>
    </dd>
    <dt><a id='formatting.Font.outline-attribute' name='formatting.Font.outline-attribute'><b>outline</b></a> [<a
            href='#formatting.Font.outline-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Font is outline style (Macintosh only)</p>
    </dd>
    <dt><a id='formatting.Font.shadow-attribute' name='formatting.Font.shadow-attribute'><b>shadow</b></a> [<a
            href='#formatting.Font.shadow-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Font is shadow style (Macintosh only)</p>
    </dd>
    <dt><a id='formatting.Font.struck_out-attribute' name='formatting.Font.struck_out-attribute'><b>struck_out</b></a> [<a
            href='#formatting.Font.struck_out-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Characters are struck out.</p>
    </dd>
    <dt><a id='formatting.Font.underline_type-attribute' name='formatting.Font.underline_type-attribute'><b>underline_type</b></a>
        [<a href='#formatting.Font.underline_type-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = None<br/>
    ...
    <dt><a id='formatting.Font.underlined-attribute' name='formatting.Font.underlined-attribute'><b>underlined</b></a> [<a
            href='#formatting.Font.underlined-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Characters are underlined. Redundant; see &quot;underline_type&quot; attribute.</p>
    </dd>
    <dt><a id='formatting.Font.weight-attribute' name='formatting.Font.weight-attribute'><b>weight</b></a> [<a
            href='#formatting.Font.weight-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.Format.format_key-attribute'
           name='formatting.Format.format_key-attribute'><b>format_key</b></a> [<a
            href='#formatting.Format.format_key-attribute'>#</a>]
    </dt>
    <dd>
        <p>The key into Book.format_map</p>
    </dd>
    <dt><a id='formatting.Format.format_str-attribute'
           name='formatting.Format.format_str-attribute'><b>format_str</b></a> [<a
            href='#formatting.Format.format_str-attribute'>#</a>]
    </dt>
    <dd>
        <p>The format string</p>
    </dd>
    <dt><a id='formatting.Format.type-attribute' name='formatting.Format.type-attribute'><b>type</b></a> [<a
            href='#formatting.Format.type-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dd>
        ...
        <p>Contains the attributes of a hyperlink.
            Hyperlink objects are accessible through Sheet.<a class="link"
                                                              href="#sheet.Sheet.hyperlink_list-variable"><b>hyperlink_list</b></a>
            and Sheet.<a class="link" href="#sheet.Sheet.hyperlink_map-variable"><b>hyperlink_map</b></a>.
            <br/>-- New in version 0.7.2
        </p>
    </dd>
    <dt><a id='sheet.Hyperlink.desc-attribute' name='sheet.Hyperlink.desc-attribute'><b>desc</b></a> [<a
            href='#sheet.Hyperlink.desc-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Hyperlink.fcolx-attribute' name='sheet.Hyperlink.fcolx-attribute'><b>fcolx</b></a> [<a
            href='#sheet.Hyperlink.fcolx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of first column</p>
    </dd>
    <dt><a id='sheet.Hyperlink.frowx-attribute' name='sheet.Hyperlink.frowx-attribute'><b>frowx</b></a> [<a
            href='#sheet.Hyperlink.frowx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of first row</p>
    </dd>
    <dt><a id='sheet.Hyperlink.lcolx-attribute' name='sheet.Hyperlink.lcolx-attribute'><b>lcolx</b></a> [<a
            href='#sheet.Hyperlink.lcolx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of last column</p>
    </dd>
    <dt><a id='sheet.Hyperlink.lrowx-attribute' name='sheet.Hyperlink.lrowx-attribute'><b>lrowx</b></a> [<a
            href='#sheet.Hyperlink.lrowx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of last row</p>
    </dd>
    <dt><a id='sheet.Hyperlink.quicktip-attribute' name='sheet.Hyperlink.quicktip-attribute'><b>quicktip</b></a> [<a
            href='#sheet.Hyperlink.quicktip-attribute'>#</a>]
    </dt>
    <dd>
        <p>The text of the &quot;quick tip&quot; displayed when the cursor
            hovers over the hyperlink.</p>
    </dd>
    <dt><a id='sheet.Hyperlink.target-attribute' name='sheet.Hyperlink.target-attribute'><b>target</b></a> [<a
            href='#sheet.Hyperlink.target-attribute'>#</a>]
    </dt>
    <dd>
        <p>Target frame. Unicode string. Note: I have not seen a case of this.
            It seems impossible to create one in the Excel UI.</p>
    </dd>
    <dt><a id='sheet.Hyperlink.textmark-attribute' name='sheet.Hyperlink.textmark-attribute'><b>textmark</b></a> [<a
            href='#sheet.Hyperlink.textmark-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Hyperlink.type-attribute' name='sheet.Hyperlink.type-attribute'><b>type</b></a> [<a
            href='#sheet.Hyperlink.type-attribute'>#</a>]
    </dt>
    <dd>
        <p>Type of hyperlink. Unicode string, one of 'url', 'unc',
            'local file', 'workbook', 'unknown'</p>
    </dd>
    <dt><a id='sheet.Hyperlink.url_or_path-attribute'
           name='sheet.Hyperlink.url_or_path-attribute'><b>url_or_path</b></a> [<a
            href='#sheet.Hyperlink.url_or_path-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='__init__.Name.area2d-method' name='__init__.Name.area2d-method'><b>area2d(clipped=True)</b></a> [<a
            href='#__init__.Name.area2d-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Name.binary-attribute' name='__init__.Name.binary-attribute'><b>binary</b></a> [<a
            href='#__init__.Name.binary-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = Formula definition; 1 = Binary data<br/> <i>No examples have been sighted.</i>
        </p></dd>
    <dt><a id='__init__.Name.builtin-attribute' name='__init__.Name.builtin-attribute'><b>builtin</b></a> [<a
            href='#__init__.Name.builtin-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = User-defined name; 1 = Built-in name
            (common examples: Print_Area, Print_Titles; see OOo docs for full list)</p>
    </dd>
    <dt><a id='__init__.Name.cell-method' name='__init__.Name.cell-method'><b>cell()</b></a> [<a
            href='#__init__.Name.cell-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Name.complex-attribute' name='__init__.Name.complex-attribute'><b>complex</b></a> [<a
            href='#__init__.Name.complex-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = Simple formula; 1 = Complex formula (array formula or user defined)<br/>
            <i>No examples have been sighted.</i>
        </p></dd>
    <dt><a id='__init__.Name.func-attribute' name='__init__.Name.func-attribute'><b>func</b></a> [<a
            href='#__init__.Name.func-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = Command macro; 1 = Function macro. Relevant only if macro == 1</p>
    </dd>
    <dt><a id='__init__.Name.funcgroup-attribute' name='__init__.Name.funcgroup-attribute'><b>funcgroup</b></a> [<a
            href='#__init__.Name.funcgroup-attribute'>#</a>]
    </dt>
    <dd>
        <p>Function group. Relevant only if macro == 1; see OOo docs for values.</p>
    </dd>
    <dt><a id='__init__.Name.hidden-attribute' name='__init__.Name.hidden-attribute'><b>hidden</b></a> [<a
            href='#__init__.Name.hidden-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = Visible; 1 = Hidden</p>
    </dd>
    <dt><a id='__init__.Name.macro-attribute' name='__init__.Name.macro-attribute'><b>macro</b></a> [<a
            href='#__init__.Name.macro-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = Standard name; 1 = Macro name</p>
    </dd>
    <dt><a id='__init__.Name.name-attribute' name='__init__.Name.name-attribute'><b>name</b></a> [<a
            href='#__init__.Name.name-attribute'>#</a>]
    </dt>
    <dd>
        <p>A Unicode string. If builtin, decoded as per OOo docs.</p>
    </dd>
    <dt><a id='__init__.Name.name_index-attribute' name='__init__.Name.name_index-attribute'><b>name_index</b></a> [<a
            href='#__init__.Name.name_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The index of this object in book.name_obj_list</p>
    </dd>
    <dt><a id='__init__.Name.raw_formula-attribute' name='__init__.Name.raw_formula-attribute'><b>raw_formula</b></a>
        [<a href='#__init__.Name.raw_formula-attribute'>#</a>]
    </dt>
    <dd>
        <p>An 8-bit string.</p>
    </dd>
    <dt><a id='__init__.Name.result-attribute' name='__init__.Name.result-attribute'><b>result</b></a> [<a
            href='#__init__.Name.result-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Name.scope-attribute' name='__init__.Name.scope-attribute'><b>scope</b></a> [<a
            href='#__init__.Name.scope-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='__init__.Name.vbasic-attribute' name='__init__.Name.vbasic-attribute'><b>vbasic</b></a> [<a
            href='#__init__.Name.vbasic-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='sheet.Note.author-attribute' name='sheet.Note.author-attribute'><b>author</b></a> [<a
            href='#sheet.Note.author-attribute'>#</a>]
    </dt>
    <dd>
        <p>Author of note</p>
    </dd>
    <dt><a id='sheet.Note.col_hidden-attribute' name='sheet.Note.col_hidden-attribute'><b>col_hidden</b></a> [<a
            href='#sheet.Note.col_hidden-attribute'>#</a>]
    </dt>
    <dd>
        <p>True if the containing column is hidden</p>
    </dd>
    <dt><a id='sheet.Note.colx-attribute' name='sheet.Note.colx-attribute'><b>colx</b></a> [<a
            href='#sheet.Note.colx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Column index</p>
    </dd>
    <dt><a id='sheet.Note.rich_text_runlist-attribute' name='sheet.Note.rich_text_runlist-attribute'><b>rich_text_runlist</b></a>
        [<a href='#sheet.Note.rich_text_runlist-attribute'>#</a>]
    </dt>
    <dd>
        <p>List of (offset_in_string, font_index) tuples.
            Unlike Sheet.<a class="link" href="#sheet.Sheet.rich_text_runlist_map-variable"><b>rich_text_runlist_map</b></a>,
            the first offset should always be 0.
        </p></dd>
    <dt><a id='sheet.Note.row_hidden-attribute' name='sheet.Note.row_hidden-attribute'><b>row_hidden</b></a> [<a
            href='#sheet.Note.row_hidden-attribute'>#</a>]
    </dt>
    <dd>
        <p>True if the containing row is hidden</p>
    </dd>
    <dt><a id='sheet.Note.rowx-attribute' name='sheet.Note.rowx-attribute'><b>rowx</b></a> [<a
            href='#sheet.Note.rowx-attribute'>#</a>]
    </dt>
    <dd>
        <p>Row index</p>
    </dd>
    <dt><a id='sheet.Note.show-attribute' name='sheet.Note.show-attribute'><b>show</b></a> [<a
            href='#sheet.Note.show-attribute'>#</a>]
    </dt>
    <dd>
        <p>True if note is always shown</p>
    </dd>
    <dt><a id='sheet.Note.text-attribute' name='sheet.Note.text-attribute'><b>text</b></a> [<a
            href='#sheet.Note.text-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formula.Operand.kind-attribute' name='formula.Operand.kind-attribute'><b>kind</b></a> [<a
            href='#formula.Operand.kind-attribute'>#</a>]
    </dt>
    <dd>
        <p>oUNK means that the kind of operand is not known unambiguously.</p>
    </dd>
    <dt><a id='formula.Operand.text-attribute' name='formula.Operand.text-attribute'><b>text</b></a> [<a
            href='#formula.Operand.text-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formula.Operand.value-attribute' name='formula.Operand.value-attribute'><b>value</b></a> [<a
            href='#formula.Operand.value-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dd>
        ...
        <p>For information about cell types and cell values, refer to the documentation of the <a class="link"
                                                                                                  href="#sheet.Cell-class"><b>Cell</b></a>
            class.</p>

        <p>WARNING: You don't call this class yourself. You access Sheet objects via the Book object that
            was returned when you called xlrd.open_workbook("myfile.xls").</p>
    </dd>
    <dt><a id='sheet.Sheet.book-attribute' name='sheet.Sheet.book-attribute'><b>book</b></a> [<a
            href='#sheet.Sheet.book-attribute'>#</a>]
    </dt>
    <dd>
        <p>A reference to the Book object to which this sheet belongs.
            Example usage: some_sheet.book.datemode</p>
    </dd>
    <dt><a id='sheet.Sheet.cell-method' name='sheet.Sheet.cell-method'><b>cell(rowx, colx)</b></a> [<a
            href='#sheet.Sheet.cell-method'>#</a>]
    </dt>
    <dd>
        <p><a class="link" href="#sheet.Cell-class"><b>Cell</b></a> object in the given row and column.
        </p></dd>
    <dt><a id='sheet.Sheet.cell_note_map-attribute' name='sheet.Sheet.cell_note_map-attribute'><b>cell_note_map</b></a>
        [<a href='#sheet.Sheet.cell_note_map-attribute'>#</a>]
    </dt>
    <dd>
        <p/>
        <p>A sparse mapping from (rowx, colx) to a <a class="link" href="#sheet.Note-class"><b>Note</b></a> object.
            Cells not containing a note ("comment") are not mapped.
            <br/>-- New in version 0.7.2 </p>
    </dd>
    <dt><a id='sheet.Sheet.cell_type-method' name='sheet.Sheet.cell_type-method'><b>cell_type(rowx, colx)</b></a> [<a
            href='#sheet.Sheet.cell_type-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.cell_value-method' name='sheet.Sheet.cell_value-method'><b>cell_value(rowx, colx)</b></a> [<a
            href='#sheet.Sheet.cell_value-method'>#</a>]
    </dt>
    <dd>
        <p>Value of the cell in the given row and column.</p>
    </dd>
    <dt><a id='sheet.Sheet.cell_xf_index-method' name='sheet.Sheet.cell_xf_index-method'><b>cell_xf_index(rowx,
        colx)</b></a> [<a href='#sheet.Sheet.cell_xf_index-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.col-method' name='sheet.Sheet.col-method'><b>col(colx)</b></a> [<a
            href='#sheet.Sheet.col-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a sequence of the <a class="link" href="#sheet.Cell-class"><b>Cell</b></a> objects in the given
            column.
        </p></dd>
    <dt><a id='sheet.Sheet.col_label_ranges-attribute'
           name='sheet.Sheet.col_label_ranges-attribute'><b>col_label_ranges</b></a> [<a
            href='#sheet.Sheet.col_label_ranges-attribute'>#</a>]
    </dt>
    <dd>
...
for crange in thesheet.col_label_ranges:
    ...
    <dt><a id='sheet.Sheet.col_slice-method' name='sheet.Sheet.col_slice-method'><b>col_slice(colx, start_rowx=0,
        end_rowx=None)</b></a> [<a href='#sheet.Sheet.col_slice-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the <a class="link" href="#sheet.Cell-class"><b>Cell</b></a> objects in the given column.
        </p></dd>
    <dt><a id='sheet.Sheet.col_types-method' name='sheet.Sheet.col_types-method'><b>col_types(colx, start_rowx=0,
        end_rowx=None)</b></a> [<a href='#sheet.Sheet.col_types-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the types of the cells in the given column.</p>
    </dd>
    <dt><a id='sheet.Sheet.col_values-method' name='sheet.Sheet.col_values-method'><b>col_values(colx, start_rowx=0,
        end_rowx=None)</b></a> [<a href='#sheet.Sheet.col_values-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the values of the cells in the given column.</p>
    </dd>
    <dt><a id='sheet.Sheet.colinfo_map-attribute' name='sheet.Sheet.colinfo_map-attribute'><b>colinfo_map</b></a> [<a
            href='#sheet.Sheet.colinfo_map-attribute'>#</a>]
    </dt>
    <dd>
        <p>The map from a column index to a <a class="link" href="#sheet.Colinfo-class"><b>Colinfo</b></a> object. Often
            there is an entry
    ...
    <dt><a id='sheet.Sheet.computed_column_width-method' name='sheet.Sheet.computed_column_width-method'><b>computed_column_width(colx)</b></a>
        [<a href='#sheet.Sheet.computed_column_width-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.default_additional_space_above-attribute'
           name='sheet.Sheet.default_additional_space_above-attribute'><b>default_additional_space_above</b></a> [<a
            href='#sheet.Sheet.default_additional_space_above-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.default_additional_space_below-attribute'
           name='sheet.Sheet.default_additional_space_below-attribute'><b>default_additional_space_below</b></a> [<a
            href='#sheet.Sheet.default_additional_space_below-attribute'>#</a>]
    </dt>
    <dd>
        <p>Default value to be used for a row if there is
            no ROW record for that row.
    ...
    <dt><a id='sheet.Sheet.default_row_height-attribute' name='sheet.Sheet.default_row_height-attribute'><b>default_row_height</b></a>
        [<a href='#sheet.Sheet.default_row_height-attribute'>#</a>]
    </dt>
    <dd>
        <p>Default value to be used for a row if there is
            no ROW record for that row.
    ...
    <dt><a id='sheet.Sheet.default_row_height_mismatch-attribute'
           name='sheet.Sheet.default_row_height_mismatch-attribute'><b>default_row_height_mismatch</b></a> [<a
            href='#sheet.Sheet.default_row_height_mismatch-attribute'>#</a>]
    </dt>
    <dd>
        <p>Default value to be used for a row if there is
            no ROW record for that row.
    ...
    <dt><a id='sheet.Sheet.default_row_hidden-attribute' name='sheet.Sheet.default_row_hidden-attribute'><b>default_row_hidden</b></a>
        [<a href='#sheet.Sheet.default_row_hidden-attribute'>#</a>]
    </dt>
    <dd>
        <p>Default value to be used for a row if there is
            no ROW record for that row.
    ...
    <dt><a id='sheet.Sheet.defcolwidth-attribute' name='sheet.Sheet.defcolwidth-attribute'><b>defcolwidth</b></a> [<a
            href='#sheet.Sheet.defcolwidth-attribute'>#</a>]
    </dt>
    <dd>
        <p>Default column width from DEFCOLWIDTH record, else None.
            ...
            For the default hierarchy, refer to the <a class="link" href="#sheet.Colinfo-class"><b>Colinfo</b></a>
            class.
            <br/> -- New in version 0.6.1
        </p></dd>
    <dt><a id='sheet.Sheet.gcw-attribute' name='sheet.Sheet.gcw-attribute'><b>gcw</b></a> [<a
            href='#sheet.Sheet.gcw-attribute'>#</a>]
    </dt>
    <dd>
        <p>A 256-element tuple corresponding to the contents of the GCW record for this sheet.
            ...
            Applies to BIFF4-7 only. See docs of the <a class="link" href="#sheet.Colinfo-class"><b>Colinfo</b></a>
            class for discussion.
        </p></dd>
    <dt><a id='sheet.Sheet.has_pane_record-attribute'
           name='sheet.Sheet.has_pane_record-attribute'><b>has_pane_record</b></a> [<a
            href='#sheet.Sheet.has_pane_record-attribute'>#</a>]
    </dt>
    <dd>
        <p>Boolean specifying if a PANE record was present, ignore unless you're xlutils.copy</p>
    </dd>
    <dt><a id='sheet.Sheet.horizontal_page_breaks-attribute' name='sheet.Sheet.horizontal_page_breaks-attribute'><b>horizontal_page_breaks</b></a>
        [<a href='#sheet.Sheet.horizontal_page_breaks-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.horz_split_first_visible-attribute' name='sheet.Sheet.horz_split_first_visible-attribute'><b>horz_split_first_visible</b></a>
        [<a href='#sheet.Sheet.horz_split_first_visible-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of first visible row in bottom frozen/split pane</p>
    </dd>
    <dt><a id='sheet.Sheet.horz_split_pos-attribute'
           name='sheet.Sheet.horz_split_pos-attribute'><b>horz_split_pos</b></a> [<a
            href='#sheet.Sheet.horz_split_pos-attribute'>#</a>]
    </dt>
    <dd>
        <p>Number of rows in top pane (frozen panes; for split panes, see comments below in code)</p>
    </dd>
    <dt><a id='sheet.Sheet.hyperlink_list-attribute'
           name='sheet.Sheet.hyperlink_list-attribute'><b>hyperlink_list</b></a> [<a
            href='#sheet.Sheet.hyperlink_list-attribute'>#</a>]
    </dt>
    <dd>
        <p/>
        <p>A list of <a class="link" href="#sheet.Hyperlink-class"><b>Hyperlink</b></a> objects corresponding to HLINK
            records found
            in the worksheet.<br/>-- New in version 0.7.2 </p>
    </dd>
    <dt><a id='sheet.Sheet.hyperlink_map-attribute' name='sheet.Sheet.hyperlink_map-attribute'><b>hyperlink_map</b></a>
        [<a href='#sheet.Sheet.hyperlink_map-attribute'>#</a>]
    </dt>
    <dd>
        <p/>
        <p>A sparse mapping from (rowx, colx) to an item in <a class="link" href="#sheet.Sheet.hyperlink_list-variable"><b>hyperlink_list</b></a>.
    ...
    <dt><a id='sheet.Sheet.merged_cells-attribute' name='sheet.Sheet.merged_cells-attribute'><b>merged_cells</b></a> [<a
            href='#sheet.Sheet.merged_cells-attribute'>#</a>]
    </dt>
    <dd>
...
for crange in thesheet.merged_cells:
    ...
    <dt><a id='sheet.Sheet.name-attribute' name='sheet.Sheet.name-attribute'><b>name</b></a> [<a
            href='#sheet.Sheet.name-attribute'>#</a>]
    </dt>
    <dd>
        <p>Name of sheet.</p>
    </dd>
    <dt><a id='sheet.Sheet.ncols-attribute' name='sheet.Sheet.ncols-attribute'><b>ncols</b></a> [<a
            href='#sheet.Sheet.ncols-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.nrows-attribute' name='sheet.Sheet.nrows-attribute'><b>nrows</b></a> [<a
            href='#sheet.Sheet.nrows-attribute'>#</a>]
    </dt>
    <dd>
        <p>Number of rows in sheet. A row index is in range(thesheet.nrows).</p>
    </dd>
    <dt><a id='sheet.Sheet.rich_text_runlist_map-attribute' name='sheet.Sheet.rich_text_runlist_map-attribute'><b>rich_text_runlist_map</b></a>
        [<a href='#sheet.Sheet.rich_text_runlist_map-attribute'>#</a>]
    </dt>
    <dd>
...
if runlist:
    ...
    <dt><a id='sheet.Sheet.row-method' name='sheet.Sheet.row-method'><b>row(rowx)</b></a> [<a
            href='#sheet.Sheet.row-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a sequence of the <a class="link" href="#sheet.Cell-class"><b>Cell</b></a> objects in the given row.
        </p></dd>
    <dt><a id='sheet.Sheet.row_label_ranges-attribute'
           name='sheet.Sheet.row_label_ranges-attribute'><b>row_label_ranges</b></a> [<a
            href='#sheet.Sheet.row_label_ranges-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.row_len-method' name='sheet.Sheet.row_len-method'><b>row_len(rowx)</b></a> [<a
            href='#sheet.Sheet.row_len-method'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.row_slice-method' name='sheet.Sheet.row_slice-method'><b>row_slice(rowx, start_colx=0,
        end_colx=None)</b></a> [<a href='#sheet.Sheet.row_slice-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the <a class="link" href="#sheet.Cell-class"><b>Cell</b></a> objects in the given row.
        </p></dd>
    <dt><a id='sheet.Sheet.row_types-method' name='sheet.Sheet.row_types-method'><b>row_types(rowx, start_colx=0,
        end_colx=None)</b></a> [<a href='#sheet.Sheet.row_types-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the types
            of the cells in the given row.</p>
    </dd>
    <dt><a id='sheet.Sheet.row_values-method' name='sheet.Sheet.row_values-method'><b>row_values(rowx, start_colx=0,
        end_colx=None)</b></a> [<a href='#sheet.Sheet.row_values-method'>#</a>]
    </dt>
    <dd>
        <p>Returns a slice of the values
            of the cells in the given row.</p>
    </dd>
    <dt><a id='sheet.Sheet.rowinfo_map-attribute' name='sheet.Sheet.rowinfo_map-attribute'><b>rowinfo_map</b></a> [<a
            href='#sheet.Sheet.rowinfo_map-attribute'>#</a>]
    </dt>
    <dd>
        <p>The map from a row index to a <a class="link" href="#sheet.Rowinfo-class"><b>Rowinfo</b></a> object. Note
            that it is possible
            to have missing entries -- at least one source of XLS files doesn't
            bother writing ROW records.
            <br/> -- New in version 0.6.1. Populated only if open_workbook(formatting_info=True).
        </p></dd>
    <dt><a id='sheet.Sheet.split_active_pane-attribute' name='sheet.Sheet.split_active_pane-attribute'><b>split_active_pane</b></a>
        [<a href='#sheet.Sheet.split_active_pane-attribute'>#</a>]
    </dt>
    <dd>
        <p>Frozen panes: ignore it. Split panes: explanation and diagrams in OOo docs.</p>
    </dd>
    <dt><a id='sheet.Sheet.standardwidth-attribute' name='sheet.Sheet.standardwidth-attribute'><b>standardwidth</b></a>
        [<a href='#sheet.Sheet.standardwidth-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.vert_split_first_visible-attribute' name='sheet.Sheet.vert_split_first_visible-attribute'><b>vert_split_first_visible</b></a>
        [<a href='#sheet.Sheet.vert_split_first_visible-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index of first visible column in right frozen/split pane</p>
    </dd>
    <dt><a id='sheet.Sheet.vert_split_pos-attribute'
           name='sheet.Sheet.vert_split_pos-attribute'><b>vert_split_pos</b></a> [<a
            href='#sheet.Sheet.vert_split_pos-attribute'>#</a>]
    </dt>
    <dd>
        <p>Number of columns in left pane (frozen panes; for split panes, see comments below in code)</p>
    </dd>
    <dt><a id='sheet.Sheet.vertical_page_breaks-attribute' name='sheet.Sheet.vertical_page_breaks-attribute'><b>vertical_page_breaks</b></a>
        [<a href='#sheet.Sheet.vertical_page_breaks-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='sheet.Sheet.visibility-attribute' name='sheet.Sheet.visibility-attribute'><b>visibility</b></a> [<a
            href='#sheet.Sheet.visibility-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.XF._alignment_flag-attribute' name='formatting.XF._alignment_flag-attribute'><b>_alignment_flag</b></a>
        [<a href='#formatting.XF._alignment_flag-attribute'>#</a>]
    </dt>
    <dd>
    </dd>
    <dt><a id='formatting.XF._background_flag-attribute' name='formatting.XF._background_flag-attribute'><b>_background_flag</b></a>
        [<a href='#formatting.XF._background_flag-attribute'>#</a>]
    </dt>
    <dd>
    </dd>
    <dt><a id='formatting.XF._border_flag-attribute' name='formatting.XF._border_flag-attribute'><b>_border_flag</b></a>
        [<a href='#formatting.XF._border_flag-attribute'>#</a>]
    </dt>
    <dd>
    </dd>
    <dt><a id='formatting.XF._font_flag-attribute' name='formatting.XF._font_flag-attribute'><b>_font_flag</b></a> [<a
            href='#formatting.XF._font_flag-attribute'>#</a>]
    </dt>
    <dd>
    </dd>
    <dt><a id='formatting.XF._format_flag-attribute' name='formatting.XF._format_flag-attribute'><b>_format_flag</b></a>
        [<a href='#formatting.XF._format_flag-attribute'>#</a>]
    </dt>
    <dd>
    </dd>
    <dt><a id='formatting.XF._protection_flag-attribute' name='formatting.XF._protection_flag-attribute'><b>_protection_flag</b></a>
        [<a href='#formatting.XF._protection_flag-attribute'>#</a>]
    </dt>
    <dd>
        <p>&#160;
        </p></dd>
    <dt><a id='formatting.XF.alignment-attribute' name='formatting.XF.alignment-attribute'><b>alignment</b></a> [<a
            href='#formatting.XF.alignment-attribute'>#</a>]
    </dt>
    <dd>
        <p>An instance of an XFAlignment object.</p>
    </dd>
    <dt><a id='formatting.XF.background-attribute' name='formatting.XF.background-attribute'><b>background</b></a> [<a
            href='#formatting.XF.background-attribute'>#</a>]
    </dt>
    <dd>
        <p>An instance of an XFBackground object.</p>
    </dd>
    <dt><a id='formatting.XF.border-attribute' name='formatting.XF.border-attribute'><b>border</b></a> [<a
            href='#formatting.XF.border-attribute'>#</a>]
    </dt>
    <dd>
        <p>An instance of an XFBorder object.</p>
    </dd>
    <dt><a id='formatting.XF.font_index-attribute' name='formatting.XF.font_index-attribute'><b>font_index</b></a> [<a
            href='#formatting.XF.font_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>Index into Book.font_list</p>
    </dd>
    <dt><a id='formatting.XF.format_key-attribute' name='formatting.XF.format_key-attribute'><b>format_key</b></a> [<a
            href='#formatting.XF.format_key-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.XF.is_style-attribute' name='formatting.XF.is_style-attribute'><b>is_style</b></a> [<a
            href='#formatting.XF.is_style-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = cell XF, 1 = style XF</p>
    </dd>
    <dt><a id='formatting.XF.parent_style_index-attribute' name='formatting.XF.parent_style_index-attribute'><b>parent_style_index</b></a>
        [<a href='#formatting.XF.parent_style_index-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.XF.protection-attribute' name='formatting.XF.protection-attribute'><b>protection</b></a> [<a
            href='#formatting.XF.protection-attribute'>#</a>]
    </dt>
    <dd>
        <p>An instance of an XFProtection object.</p>
    </dd>
    <dt><a id='formatting.XF.xf_index-attribute' name='formatting.XF.xf_index-attribute'><b>xf_index</b></a> [<a
            href='#formatting.XF.xf_index-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.XFAlignment.hor_align-attribute' name='formatting.XFAlignment.hor_align-attribute'><b>hor_align</b></a>
        [<a href='#formatting.XFAlignment.hor_align-attribute'>#</a>]
    </dt>
    <dd>
        <p>Values: section 6.115 (p 214) of OOo docs</p>
    </dd>
    <dt><a id='formatting.XFAlignment.indent_level-attribute' name='formatting.XFAlignment.indent_level-attribute'><b>indent_level</b></a>
        [<a href='#formatting.XFAlignment.indent_level-attribute'>#</a>]
    </dt>
    <dd>
        <p>A number in range(15).</p>
    </dd>
    <dt><a id='formatting.XFAlignment.rotation-attribute'
           name='formatting.XFAlignment.rotation-attribute'><b>rotation</b></a> [<a
            href='#formatting.XFAlignment.rotation-attribute'>#</a>]
    </dt>
    <dd>
    ...
    <dt><a id='formatting.XFAlignment.shrink_to_fit-attribute' name='formatting.XFAlignment.shrink_to_fit-attribute'><b>shrink_to_fit</b></a>
        [<a href='#formatting.XFAlignment.shrink_to_fit-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = shrink font size to fit text into cell.</p>
    </dd>
    <dt><a id='formatting.XFAlignment.text_direction-attribute'
           name='formatting.XFAlignment.text_direction-attribute'><b>text_direction</b></a> [<a
            href='#formatting.XFAlignment.text_direction-attribute'>#</a>]
    </dt>
    <dd>
        <p>0 = according to context; 1 = left-to-right; 2 = right-to-left</p>
    </dd>
    <dt><a id='formatting.XFAlignment.text_wrapped-attribute' name='formatting.XFAlignment.text_wrapped-attribute'><b>text_wrapped</b></a>
        [<a href='#formatting.XFAlignment.text_wrapped-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = text is wrapped at right margin</p>
    </dd>
    <dt><a id='formatting.XFAlignment.vert_align-attribute' name='formatting.XFAlignment.vert_align-attribute'><b>vert_align</b></a>
        [<a href='#formatting.XFAlignment.vert_align-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.XFBackground.background_colour_index-attribute'
           name='formatting.XFBackground.background_colour_index-attribute'><b>background_colour_index</b></a> [<a
            href='#formatting.XFBackground.background_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>See section 3.11 of the OOo docs.</p>
    </dd>
    <dt><a id='formatting.XFBackground.fill_pattern-attribute' name='formatting.XFBackground.fill_pattern-attribute'><b>fill_pattern</b></a>
        [<a href='#formatting.XFBackground.fill_pattern-attribute'>#</a>]
    </dt>
    <dd>
        <p>See section 3.11 of the OOo docs.</p>
    </dd>
    <dt><a id='formatting.XFBackground.pattern_colour_index-attribute'
           name='formatting.XFBackground.pattern_colour_index-attribute'><b>pattern_colour_index</b></a> [<a
            href='#formatting.XFBackground.pattern_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>See section 3.11 of the OOo docs.</p>
    </dd>
...
<dl>
    ...
    <dt><a id='formatting.XFBorder.bottom_colour_index-attribute'
           name='formatting.XFBorder.bottom_colour_index-attribute'><b>bottom_colour_index</b></a> [<a
            href='#formatting.XFBorder.bottom_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The colour index for the cell's bottom line</p>
    </dd>
    <dt><a id='formatting.XFBorder.bottom_line_style-attribute'
           name='formatting.XFBorder.bottom_line_style-attribute'><b>bottom_line_style</b></a> [<a
            href='#formatting.XFBorder.bottom_line_style-attribute'>#</a>]
    </dt>
    <dd>
        <p>The line style for the cell's bottom line</p>
    </dd>
    <dt><a id='formatting.XFBorder.diag_colour_index-attribute'
           name='formatting.XFBorder.diag_colour_index-attribute'><b>diag_colour_index</b></a> [<a
            href='#formatting.XFBorder.diag_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The colour index for the cell's diagonal lines, if any</p>
    </dd>
    <dt><a id='formatting.XFBorder.diag_down-attribute' name='formatting.XFBorder.diag_down-attribute'><b>diag_down</b></a>
        [<a href='#formatting.XFBorder.diag_down-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = draw a diagonal from top left to bottom right</p>
    </dd>
    <dt><a id='formatting.XFBorder.diag_line_style-attribute' name='formatting.XFBorder.diag_line_style-attribute'><b>diag_line_style</b></a>
        [<a href='#formatting.XFBorder.diag_line_style-attribute'>#</a>]
    </dt>
    <dd>
        <p>The line style for the cell's diagonal lines, if any</p>
    </dd>
    <dt><a id='formatting.XFBorder.diag_up-attribute' name='formatting.XFBorder.diag_up-attribute'><b>diag_up</b></a>
        [<a href='#formatting.XFBorder.diag_up-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = draw a diagonal from bottom left to top right</p>
    </dd>
    <dt><a id='formatting.XFBorder.left_colour_index-attribute'
           name='formatting.XFBorder.left_colour_index-attribute'><b>left_colour_index</b></a> [<a
            href='#formatting.XFBorder.left_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The colour index for the cell's left line</p>
    </dd>
    <dt><a id='formatting.XFBorder.left_line_style-attribute' name='formatting.XFBorder.left_line_style-attribute'><b>left_line_style</b></a>
        [<a href='#formatting.XFBorder.left_line_style-attribute'>#</a>]
    </dt>
    <dd>
        <p>The line style for the cell's left line</p>
    </dd>
    <dt><a id='formatting.XFBorder.right_colour_index-attribute'
           name='formatting.XFBorder.right_colour_index-attribute'><b>right_colour_index</b></a> [<a
            href='#formatting.XFBorder.right_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The colour index for the cell's right line</p>
    </dd>
    <dt><a id='formatting.XFBorder.right_line_style-attribute' name='formatting.XFBorder.right_line_style-attribute'><b>right_line_style</b></a>
        [<a href='#formatting.XFBorder.right_line_style-attribute'>#</a>]
    </dt>
    <dd>
        <p>The line style for the cell's right line</p>
    </dd>
    <dt><a id='formatting.XFBorder.top_colour_index-attribute' name='formatting.XFBorder.top_colour_index-attribute'><b>top_colour_index</b></a>
        [<a href='#formatting.XFBorder.top_colour_index-attribute'>#</a>]
    </dt>
    <dd>
        <p>The colour index for the cell's top line</p>
    </dd>
    <dt><a id='formatting.XFBorder.top_line_style-attribute' name='formatting.XFBorder.top_line_style-attribute'><b>top_line_style</b></a>
        [<a href='#formatting.XFBorder.top_line_style-attribute'>#</a>]
    </dt>
    <dd>
...
<dl>
    ...
    <dt><a id='formatting.XFProtection.cell_locked-attribute' name='formatting.XFProtection.cell_locked-attribute'><b>cell_locked</b></a>
        [<a href='#formatting.XFProtection.cell_locked-attribute'>#</a>]
    </dt>
    <dd>
        <p>1 = Cell is prevented from being changed, moved, resized, or deleted
            (only if the sheet is protected).</p>
    </dd>
    <dt><a id='formatting.XFProtection.formula_hidden-attribute'
           name='formatting.XFProtection.formula_hidden-attribute'><b>formula_hidden</b></a> [<a
            href='#formatting.XFProtection.formula_hidden-attribute'>#</a>]
    </dt>
    <dd>
